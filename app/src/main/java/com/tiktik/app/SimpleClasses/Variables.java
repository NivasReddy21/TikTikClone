package com.tiktik.app.SimpleClasses;
...
//it's default package name//y,ou need to change package name first then put the sha key with firebase and add json file here, oh sorry. can you change that? I am still leanrning I couldn't do it. without errors. I will pay you //ok sure
/**
 * Created by AQEEL on 2/15/2019.
 */

public class Variables {
///open chrome, ok. give me one mome

    //com        urbantech        oodi
    //what need to be done now?, odi app is working fine, just that there are no sounds in directory. Here is the DEsktop GUI
   ...
   //There is no issue from application, there was an issue with SHA keys, when I take apk and run it on phone, issue is with facebook after app will be live on store we dont' need sha key any more just for debugging process we need tat, ok, can you please check the firebase once to ensure everything is fine?
    public static String gif_api_key1="giphy_api_key_here"; //all set done.. I tried doing it, but it wasn;t working properly. you sure both facebook and google authentication is done/?/have ou added facebook appid and secret key? there was wroign in server path, can you please verify it once for me?//ok
//open chrome
    public static final String privacy_policy="https://www.privacypolicygenerator.info/live.php?token=";

// please copy, copy what?  // http://thetaktakapp.com/thetaktakapp.com/API/index.php?p=showAllVideos
    //uninstall old apk or clear data, ok //connect your device, no run emulator here, no issues.//ok
   
    public static final  String main_domain="http://thetaktakapp.com/";
